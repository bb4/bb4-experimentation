...
object GcfProgram:
  ...
  def main(args: Array[String]): Unit =
    ...
    // val a = 36618
    // val b = 8105362
    println(s"Finding Greatest Common Factor of a=$a and b=$b")
    showResult(a, b, euclidSolver)
    showResult(a, b, bruteSolver)

  private def showResult(a: Long, b: Long, solver: GcfSolver): Unit =
    println("finding answer using " + solver.getClass.getName + " ... ")
    val time = System.currentTimeMillis
    val answer = solver.findSolution(a, b)
    val elapsedTime = System.currentTimeMillis - time
    println(s"found answer = $answer in time = $elapsedTime milliseconds\n")
